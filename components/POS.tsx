          ...
          <div className="p-4 border-b border-slate-100 flex flex-col md:flex-row gap-3 md:gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50/80 backdrop-blur-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500 focus:bg-white transition-all shadow-sm"
              />
            </div>
            <select
              ...
              if ('parts' in item) {
                return (
                  <div
                    ...
                    className="bg-gradient-to-br from-indigo-500 to-indigo-700 p-3 md:p-4 rounded-2xl border border-indigo-400 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(79,70,229,0.3)] hover:-translate-y-1 cursor-pointer transition-all active:scale-95 flex flex-col h-full min-h-[130px] relative group overflow-hidden"
                  >
